...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#site-navbar" data-offset="200">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark site_navbar bg-dark site-navbar-light" id="site-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.html">E-BANK</a>
        ...
        <div class="collapse navbar-collapse" id="site-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="adminprofile.php" class="nav-link">Approved/Delete Users</a></li>
            <li class="nav-item"><a href="post_news.php" class="nav-link">Post News</a></li>
            <li class="nav-item"><a href="logout2.php" class="nav-link">Log Out</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <section class="site-cover" style="background-image: url(images/admin.jpg);" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center site-vh-100">
          <div class="col-md-12">
            <h1 class="site-heading site-animate mb-3">HELLO ADMIN</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 site-animate">
            <p><img src="images/bg55.jpg" alt="" class="img-fluid"></p>
            <p class="text-black">
              Address: <br>Asansol  <br> Bagbandi Road 713339 <br> <br>
              Phone: <br> 855451254 <br> <br>
              Email: <br> <a href="mailto:info@yoursite.com">AIEM-Pstudent@gmail.com</a>
            </p>
    ...
    <footer class="site-footer site-bg-dark site-section">
      <div class="container">
        ...
        <div class="row site-animate">
          ...
          <div class="col-md-12 text-center">
            <p>&copy; 
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by <a href="index.html" target="_blank">E-BANK</a>
</p>
          </div>
        </div>
      </div>
