...
<head>
    ...
    <link href="chome.css" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="site-nav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item"><a href="viewtransaction.php" class="nav-link">My Transactions</a></li>
            <li class="nav-item"><a href="transaction.php" class="nav-link">Transfer Funds</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 site-animate">
            ...
            <p class="text-black">
              Address: <br> khagra ghat  <br> Berhampore,742143 <br> <br>
              Phone: <br> 9876543210 <br> <br>
              Email: <br> <a href="mailto:info@yoursite.com">gimstudent@gmail.com</a></p>
    ...
    <footer class="site-footer site-bg-dark site-section">
      <div class="container">
        ...
        <div class="row site-animate">
           <div class="col-md-12 text-center">
            <div class="site-footer-widget mb-4">
              <ul class="site-footer-social list-unstyled ">
                ...
                <li class="site-animate"><a href="https://www.facebook.com/soumajit.ghosh.520125"><span class="icon-facebook"></span></a></li>
          ...
          <div class="col-md-12 text-center">
            <p>&copy; 
Copyright <script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made by <a href="https://colorlib.com" target="_blank">AIEM-P_STUDENTS</a>
</p>
          </div>
        </div>
      </div>
              ...
              <div class="col-lg-12 p-5">
                ...
                <form action="customer_login_action.php" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6"><h4> Create an account <a href="signup.html">Sign Up?</a></h4></div>
                  </div>
                </form>
              </div>
            </div>
